...
class LocalCoreDataService {
    ...
    func updateMovie(movieDictionary: [String:String], movie: MovieManaged, order: Int) {
        ...
        movie.director = movieDictionary["direcor"]
        ...
        do {
            ...
            print("Error while updating Core Date")
    ...
    func getFavoriteMovies() -> [Movie]? {
        ...
        do {
            ...
            print("Error while getting favorites from Core Data")
            return nil
        }
    ...
    func updateFavoritesBadge() {
        ...
        if let totalFavorites = getFavoriteMovies()?.count {
            let notification = Notification(name: Notification.Name("updateFavoritesBadgeNotification"),
                                            object: totalFavorites, userInfo: nil)
